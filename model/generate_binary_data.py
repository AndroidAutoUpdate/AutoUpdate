...
# DATA_DIR = r"/home/yueyue/AndroZoo/baseline/subword_tokenized/with_new_tokens/android/medium/BPE.m_2000"
# BINARY_DATA_DIR = r"/home/yueyue/AndroZoo/baseline/binary/with_new_tokens/android/medium/"

DATA_DIR = sys.argv[1]
BINARY_DATA_DIR = sys.argv[2]


# TRAIN_DATA_DIR = os.path.join(DATA_DIR,'0')
# VALID_DATA_DIR = os.path.join(DATA_DIR,'1')
