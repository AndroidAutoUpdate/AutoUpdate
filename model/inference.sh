...
# BINARY_T2T_DATA_DIR="/home/yueyue/AndroZoo/baseline/binary/with_new_tokens/android/medium/"
# SAVED_MODEL_DIR="model_train/saved_models/hparams1_baseline_train53000"
# INPUT_FILE="/home/yueyue/AndroZoo/baseline/subword_tokenized/with_new_tokens/android/medium/BPE.m_2000/test/before.txt"
# HPARAMS_NAME="transformer_hparams1"
# TRAIN_STEP=53000
# BEAM_SIZE=5
...
MODEL=transformer
USR_DIR=model_train/auto_transform
